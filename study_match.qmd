...
4. Fit single best model

+ 1x 10-fold simple CV in the full dataset (mimic inner loop process), select model with best auROC across 10 held-out folds (*In progress*)
